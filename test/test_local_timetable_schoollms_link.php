...
$data->password = "$0W3t0";
$data->host = "localhost";
$data->db = "school_lms_prod_schools_mgslg_teach";
...
//action=add_user_subject&user_id=2&year_id=3
...
$q = "SELECT * FROM school_lms_qa_support.schoollms_schema_userdata_access_profile WHERE user_id = $user_id";
...
if ($data->numrows > 0){
    ...
    if ($numrows > 0){
        ...
        $q = "SELECT * FROM school_lms_qa_support.$table WHERE user_id = $user_id AND year_id = $year_id";
        ...
        foreach ($result as $key=>$row){
            ...
            switch($user_type){
                case 2://Learner
                    ...
                    $q = "SELECT * FROM school_lms_qa_support.schoollms_schema_userdata_school_classes WHERE school_id = $school_id AND class_id = $class_id";
                    $data2->execSQL($q);
                    $row1 = $data2->getRow();
                ...
                case 4://Teacher
                    ...
                    $q = "SELECT * FROM school_lms_qa_support.schoollms_schema_userdata_school_subjects WHERE subject_id = $subject_id";
                    $data2->execSQL($q);
                    $row1 = $data2->getRow();
