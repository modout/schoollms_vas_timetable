...
<body>
<div class="header" style="z-index: 100;background-color:#e0e0e0;"><center>
	<?php
	$user_type = 0;
		if($user_type == 6)
			{
...
<div id="content" style="margin-top: 100px">
	<ul class="nav nav-tabs responsive with-nav-tabs.panel-primary" id="myTab" style="margin-top: 50px;">
	  ...
	  <li class="active"><a href="#reg">Registered Schools</a></li>
	...
	<div class="tab-content responsive" style="margin-top: 100px;" style="margin-top: 50px;">
		...
		<div class="tab-pane" id="users" style="border: none">
			<?php
